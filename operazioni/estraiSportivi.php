...
$libriSportivi = estraiLibriSportivi($conn);

// Salva i dati nella sessione solo se ci sono libri estratti
if (!empty($libriSportivi)) {
    $_SESSION['libriSportivi'] = $libriSportivi;
} else {
    $_SESSION['libriSportivi'] = [];  // Salva un array vuoto se non ci sono libri
}
